# Inner Bloom Result Page — Native Shopify HTML/CSS
...
1. Shopify Admin → Pages → Add page (or open existing inner-bloom-result page)
2. Set page title: `Inner Bloom — Your Wellness Match`
3. In the content editor: click **Show HTML** (`<>`) icon
4. Select all existing content → delete
5. Paste the entire HTML block below
6. Click **Save** — do NOT set page to visible yet
7. Preview the page before publishing

Do NOT click "Make page visible" until mobile QA passes.
...
```html
<!-- ============================================================
     VV Inner Bloom Result Page — Native HTML/CSS
     Vital Vision Shop | inner-bloom-result
     No JavaScript. No external dependencies. Draft only.
     ============================================================ -->
...
/* ── Hero ── */
.vv-hero{padding:64px 20px;text-align:center}
.vv-hero-disclaimer{margin-top:16px;font-size:11px;color:rgba(255,248,236,.55)}

/* ── Profile block ── */
.vv-callout{border:1px solid #E8DDC8;border-radius:6px;padding:20px;background:#FFFFFF;margin-top:20px}
...
/* ── Product card ── */
.vv-product-card{border:1px solid #E8DDC8;border-radius:8px;padding:28px 24px;margin-top:24px;background:#FFFFFF}
...
.vv-details{border:1px solid #E8DDC8;border-radius:6px;background:#FFFFFF;overflow:hidden;margin-bottom:10px}
...
.vv-card{border:1px solid #E8DDC8;border-radius:8px;padding:24px 20px;background:#FFFFFF}
...
@media(min-width:768px){
  .vv-hero{padding:96px 40px}
  .vv-hero .vv-h1{font-size:44px}
...
<div class="vv-page">
  ...
  <!-- ══════════════════════════════════════════════════════════════
       SECTION 1 — HERO
       ══════════════════════════════════════════════════════════════ -->
  <div class="vv-section vv-bg-green vv-hero vv-center">
    <div class="vv-inner">
      <span class="vv-eyebrow">Your Quiz Result ✨</span>
      <h1 class="vv-h1">Your Inner Bloom Match ✨</h1>
      <p class="vv-subhead">Based on your answers, Inner Bloom was selected as your gut wellness starting point.</p>
  ...
  <div class="vv-section vv-bg-white">
    <div class="vv-inner">
      ...
      <div class="vv-product-card">
        ...
        <p class="vv-product-desc">Inner Bloom is an advanced probiotic formula designed to support healthy digestion and daily gut balance as part of a consistent wellness routine. One simple ritual — every morning.</p>
