# Inner Bloom Result Page — Native Shopify HTML/CSS v10 Final Clean
# Page: Inner Bloom — Your Wellness Match
# URL handle: inner-bloom-result
# Vital Vision Shop
# Generated: 2026-05-13
# Version: v10-final-clean
# Base: v9-final-polish — same structure, final hero cleanup only
...
#
# Changes from v9-final-polish:
#   REMOVED  — Small hero disclaimer line ("Educational only. Not medical advice.
#              Results may vary.") from directly under the hero CTA button.
#              Hero area is now cleaner: eyebrow → h1 → subtitle → CTA only.
#   CONFIRMED — Compliance/FDA disclaimer remains in: trust strip + FAQ + final CTA.
#   INCREASED — .v8-hero-sub margin-bottom: 20px → 28px
#              More breathing room between subtitle and gold CTA button.
#   UNCHANGED — margin-top: -72px (gap reduction above hero)
#   UNCHANGED — object-position: 80% 66% (approved mobile hero crop)
#   UNCHANGED — Desktop hero: object-position center right, min-height 420px
#   UNCHANGED — All other copy, structure, trust items, product card, FAQ
...
```html
<!-- ============================================================
     VV Inner Bloom Result Page — Native HTML/CSS v10 Final Clean
     Vital Vision Shop | inner-bloom-result
     7 sections. No JavaScript. Shopify CDN images only.
     Draft only. No origin claims. Hero disclaimer removed from hero area.
     FDA disclaimer present in trust strip, FAQ, and final CTA.
     ============================================================ -->
...
.vvp8 {
  ...
  /* Cancels Refresh section top padding. If a gap appears above the hero,
     increase magnitude (e.g. -88px). If hero clips at top, decrease (e.g. -56px). */
  margin-top: -72px;
}
...
.v8-hero-img {
  ...
  object-fit: cover;
  /* Mobile crop: 80% right, 66% down — shows woman + glass/hand.
     Overridden for desktop below. */
...
.v8-hero-sub {
  ...
  margin-bottom: 28px; /* CLEAN: was 20px — more room before CTA */
  max-width: 340px;
}
/* No .v8-hero-note here — hero disclaimer removed from hero area for cleaner UX.
   FDA/educational disclaimer is present in: trust strip + FAQ + final CTA. */
...
/* ══════════════════════════════════════════════════════════════
   5 — COMPACT TRUST STRIP (4 badges + FDA disclaimer)
   ══════════════════════════════════════════════════════════════ */
.v8-trust-strip {
...
<div class="vvp8">
  ...
  <!-- ════════════════════════════════════════════════════════════
       ...
       Hero disclaimer removed. Compliance present in trust strip,
       FAQ answers, and final CTA note below.
       ════════════════════════════════════════════════════════════ -->
  <div class="v8-hero">
  ...
  <div class="v8-section v8-bg-cream">
    <div class="v8-inner">
      ...
      <!-- Trust strip — no origin claims. FDA disclaimer present here. -->
...
<!-- ============================================================
     End VV Inner Bloom Result Page v10 Final Clean
     ============================================================ -->
```
