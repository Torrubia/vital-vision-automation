# Inner Bloom Result Page — Native Shopify HTML/CSS v8 Ultra-Compact
# Page: Inner Bloom — Your Wellness Match
# URL handle: inner-bloom-result
# Vital Vision Shop
# Generated: 2026-05-13
# Version: v8-ultra-compact — mobile-first, conversion-focused, ~3–4 screen scrolls before FAQ
# Sections: 7 (Hero → Product → Why 3 cards → Ritual + Trust → FAQ → Final CTA)
...
# Changes from v6-compact:
#   REMOVED — 4 tall benefit card section (replaced with 3 compact inline reason cards)
#   REMOVED — Standalone transparency section
#   REMOVED — "Our Commitment to You" section
#   REMOVED — Repeated disclaimer blocks
#   REDUCED — Hero image height: 220px → 150px mobile
#   REDUCED — All section padding: 48px → 32px mobile
#   REDUCED — Letter-spacing on body/heading text
#   REDUCED — Mobile heading sizes
#   ADDED   — 3-card compact reason row (replaces 4-tall cards)
#   ADDED   — 4 specified trust badges inline
...
```html
<!-- ============================================================
     VV Inner Bloom Result Page — Native HTML/CSS v8 Ultra-Compact
...
.v8-hero-img-col { order: 1; overflow: hidden; height: 150px; } /* Compact mobile height */
.v8-hero-img {
  width: 100%; height: 100%;
  object-fit: cover; object-position: center 18%; display: block;
}
.v8-hero-copy {
  order: 2; padding: 28px 20px 36px;
...
.v8-hero-note {
  ...
  color: rgba(255,248,236,.42); line-height: 1.5;
}
...
@media(min-width: 768px) {
  ...
  /* Product card */
  .v8-product-card    { grid-template-columns: 36% 64%; }
...
<!-- ============================================================
     End VV Inner Bloom Result Page v8 Ultra-Compact
     ============================================================ -->
```
