# Inner Bloom Result Page — Native Shopify HTML/CSS v8 Mobile Polished (No Origin Claim)
# Page: Inner Bloom — Your Wellness Match
# URL handle: inner-bloom-result
# Vital Vision Shop
# Generated: 2026-05-13
# Version: v8-mobile-polished-no-origin-claim
# Base: v8-ultra-compact — same structure, targeted mobile polish only
...
#
# Changes from v8-ultra-compact:
#   REMOVED  — "Made in USA with globally sourced ingredients" (origin/manufacturing claim)
#   REPLACED — with "Quality-focused daily wellness support." (neutral trust claim)
#   POLISHED — Hero disclaimer: font-size 10px → 12px, line-height 1.5 → 1.4, opacity .42 → .75, margin-top 10px → 16px
#   POLISHED — Hero copy padding reduced: 28px 20px 36px → 24px 20px 28px
#   POLISHED — Product card margin-top: 20px → 36px (adds ~16px breathing room below hero)
#   UNCHANGED — Hero image, product image, hero crop, layout, length, CTA, URLs
...
```html
<!-- ============================================================
     VV Inner Bloom Result Page — Native HTML/CSS v8 Mobile Polished
...
.v8-btn-outline {
  ...
  font-size: 14px; min-height: 44px; padding: 10px 20px;
}

/* ══════════════════════════════════════════════════════════════
   1 — COMPACT SPLIT HERO
   Mobile: lifestyle image top (150px), copy below.
   Desktop: copy left 52% / image right 48%.
   ══════════════════════════════════════════════════════════════ */
.v8-hero {
...
.v8-hero-copy {
  order: 2; padding: 24px 20px 28px; /* POLISHED: reduced from 28px/36px */
...
.v8-hero-note {
  margin-top: 16px;          /* POLISHED: was 10px */
  font-size: 12px;           /* POLISHED: was 10px */
  line-height: 1.4;          /* POLISHED: was 1.5 */
  color: rgba(255,248,236,.75); /* POLISHED: was .42 — easier to read */
}
...
.v8-product-card {
  ...
  margin-top: 36px; /* POLISHED: was 20px — adds ~16px breathing room below hero */
  display: grid; grid-template-columns: 1fr;
}
.v8-product-img-col {
...
/* ══════════════════════════════════════════════════════════════
   ...
   3-col stacked on mobile, 3-col row on desktop.
   ══════════════════════════════════════════════════════════════ */
...
<!-- ============================================================
     End VV Inner Bloom Result Page v8 Mobile Polished (No Origin Claim)
     ============================================================ -->
```
