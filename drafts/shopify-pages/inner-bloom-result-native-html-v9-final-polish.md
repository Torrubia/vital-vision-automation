# Inner Bloom Result Page — Native Shopify HTML/CSS v9 Final Polish
# Page: Inner Bloom — Your Wellness Match
# URL handle: inner-bloom-result
# Vital Vision Shop
# Generated: 2026-05-13
# Version: v9-final-polish
# Base: v8-final-mobile-crop-v2 — identical except 4 targeted mobile visual fixes
...
#
# Changes from v8-final-mobile-crop-v2 (mobile-only unless noted):
#   CHANGED — .vvp8 margin-top: -44px → -72px
#              Reduces white gap above hero by ~60%. Adjust if hero clips at top.
#   CHANGED — .v8-hero-h1 font-size: 26px → 24px (mobile only; desktop still 38px)
#              Slightly less oversized on small screens. Still premium and strong.
#   CHANGED — .v8-hero-note margin-top: 16px → 20px
#              More breathing room between CTA button and disclaimer line.
#   CHANGED — Mobile hero object-position: 78% 62% → 80% 66%
#              Shifts crop further right and down. Glass/hand more visible.
#              Face verified to remain in frame at this value.
#   UNCHANGED — Desktop hero: object-position center right, min-height 420px (untouched)
#   UNCHANGED — All copy, structure, trust items, CTA, product card, compliance
...
```html
<!-- ============================================================
     VV Inner Bloom Result Page — Native HTML/CSS v9 Final Polish
...
.vvp8 {
  ...
  /* POLISH: was -44px. Increased to -72px to reduce the white gap above the
     hero by ~60%. If the hero clips at top after paste, decrease magnitude
     (e.g. -56px). If a gap still appears, increase (e.g. -88px). */
  margin-top: -72px;
}
...
.v8-hero-img {
  ...
  /* POLISH: was 78% 62%. Shifted to 80% 66% — further right + further down.
     Shows more of the glass/hand at lower-right. Face stays in frame.
     Desktop overrides this to: object-position center right (unchanged). */
...
.v8-hero-h1 {
  /* POLISH: was 26px. Slightly less oversized on mobile — still premium. */
...
.v8-hero-note {
  /* POLISH: margin-top 16px → 20px. More room between CTA and disclaimer. */
  margin-top: 20px;
  font-size: 12px;
  line-height: 1.4;
...
/* ══════════════════════════════════════════════════════════════
   ...
   All hero values here override the mobile-first base above.
   ══════════════════════════════════════════════════════════════ */
@media(min-width: 768px) {
  ...
  /* Hero — desktop layout and crop UNCHANGED from all prior versions */
  ...
  .v8-hero-img     {
    object-position: center right; /* desktop crop: unchanged */
    height: 100%;
    border-radius: 20px 0 0 20px;
  }
  .v8-hero-h1 { font-size: 38px; } /* desktop heading restored to full size */
...
<!-- ============================================================
     End VV Inner Bloom Result Page v9 Final Polish
     ============================================================ -->
```
