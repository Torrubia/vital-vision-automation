...
# Version: v11-mobile-conversion
# Base: v10-final-clean — same structure, mobile conversion tightening only
...
```html
<!-- ============================================================
     VV Inner Bloom Result Page — Native HTML/CSS v11 Mobile Conversion
...
.v8-hero-img-col { order: 1; overflow: hidden; height: 175px; }
.v8-hero-img {
...
.v8-hero-copy {
  order: 2; padding: 24px 20px 32px;
...
<!-- ============================================================
     End VV Inner Bloom Result Page v11 Mobile Conversion
     AUTO_PUBLISH=false | REQUIRE_HUMAN_APPROVAL=true
     ============================================================ -->
```
