# Inner Bloom Result Page — Native Shopify HTML/CSS v8 Final Mobile Optimized
# Page: Inner Bloom — Your Wellness Match
# URL handle: inner-bloom-result
# Vital Vision Shop
# Generated: 2026-05-13
# Version: v8-final-mobile-optimized
# Base: v8-mobile-polished-no-origin-claim — same structure, final fixes applied
...
#
# Changes from v8-mobile-polished-no-origin-claim:
#   FIXED    — Mobile hero image crop: object-position center 18% → 70% 20%
#              Shows woman + glass/hand more clearly on mobile. Face stays visible.
#              Desktop hero crop unchanged (still: object-position center right).
#   CONFIRMED — No origin claims in HTML (Made in USA / globally sourced removed)
#   CONFIRMED — Trust item: "Quality-focused daily wellness support." (replaces origin claim)
#   CONFIRMED — All mobile polish from prior version retained:
#     hero copy padding: 24px 20px 28px
#     hero note: font-size 12px / line-height 1.4 / opacity .75 / margin-top 16px
#     product card margin-top: 36px (+16px gap below hero)
...
```html
<!-- ============================================================
     VV Inner Bloom Result Page — Native HTML/CSS v8 Final Mobile Optimized
...
.vvp8 {
  ...
  /* Refresh theme full-width breakout — no theme file edits needed */
  width: 100vw;
  position: relative;
  left: 50%;
  ...
  /* Cancel Refresh section top padding (~44px). Adjust if gap appears. */
  margin-top: -44px;
}
...
/* ══════════════════════════════════════════════════════════════
   ...
   Mobile: lifestyle image top (150px tall), copy below.
...
.v8-hero-img-col { order: 1; overflow: hidden; height: 150px; }
.v8-hero-img {
  width: 100%; height: 100%; display: block;
  object-fit: cover;

  /* MOBILE CROP FIX: shift right to show woman + glass/hand.
     70% horizontal (right of center) and 20% from top keeps
     face visible while revealing the hand/glass in frame.
     Desktop overrides this to: center right (unchanged). */
...
.v8-product-card {
  ...
  margin-top: 36px; /* +16px more gap below hero vs original 20px */
  display: grid; grid-template-columns: 1fr;
}
.v8-product-img-col {
...
/* ══════════════════════════════════════════════════════════════
   ...
   Stacked on mobile, 3-col row on desktop.
   ══════════════════════════════════════════════════════════════ */
...
/* ══════════════════════════════════════════════════════════════
   6 — FAQ (3 questions, native details/summary, no JavaScript)
   ══════════════════════════════════════════════════════════════ */
...
@media(min-width: 768px) {
  ...
  .v8-hero-img     {
    object-position: center right; /* DESKTOP CROP: unchanged from all prior versions */
    height: 100%;
...
<div class="vvp8">
  ...
  <div class="v8-section v8-bg-cream">
    <div class="v8-inner">
      ...
      <!-- Trust strip — 4 badges + FDA note. No origin claims. -->
...
<!-- ============================================================
     End VV Inner Bloom Result Page v8 Final Mobile Optimized
     ============================================================ -->
```
