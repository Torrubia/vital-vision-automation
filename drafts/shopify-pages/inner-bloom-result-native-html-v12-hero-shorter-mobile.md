...
# Version: v12-hero-shorter-mobile
# Base: v11-mobile-conversion — same structure, mobile hero height reduction only
...
```html
<!-- ============================================================
     VV Inner Bloom Result Page — Native HTML/CSS v12 Hero Shorter Mobile
...
.v8-hero-img-col { order: 1; overflow: hidden; height: 128px; } /* REDUCED: was 175px (-27%) */
.v8-hero-img {
...
<!-- ============================================================
     End VV Inner Bloom Result Page v12 Hero Shorter Mobile
     AUTO_PUBLISH=false | REQUIRE_HUMAN_APPROVAL=true
     ============================================================ -->
```
